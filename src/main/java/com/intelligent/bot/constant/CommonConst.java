...
public class CommonConst {
    ...
    public static final String VARY_STRONG = "high_variation";

    public static final String VARY_SUBTLE = "low_variation";

    public static final String UPSCALE2 = "upsample_v5_2x";

    public static final String UPSCALE4 = "upsample_v5_4x";

    public static final Integer ZOOM_OUT_2X = 50;

    public static final Integer ZOOM_OUT_15X = 75;
