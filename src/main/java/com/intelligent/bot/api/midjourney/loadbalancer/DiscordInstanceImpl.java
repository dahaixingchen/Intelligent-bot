...
public class DiscordInstanceImpl implements DiscordInstance {
	...
	@Override
	public B<Void> submitVary(String vary,String messageId, String messageHash, int messageFlags, String nonce) {
		return this.service.submitVary(vary,messageId, messageHash, messageFlags, nonce);
	}

	@Override
	public B<Void> submitZoomOut(Integer zoomOut,String messageId, String messageHash, int messageFlags, String nonce) {
		return this.service.submitZoomOut(zoomOut,messageId, messageHash, messageFlags, nonce);
	}

	@Override
	public B<Void> submitPan(String plan, String messageId, String messageHash, int messageFlags, String nonce) {
		return this.service.submitPan(plan,messageId, messageHash, messageFlags, nonce);
	}
	...
	@Override
	public B<Void> shorten(String prompt,String nonce,Long id) {
		return this.service.shorten(prompt,nonce,id);
	}
